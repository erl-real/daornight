...
export class ArcadePreview {
    ...
    addBaseScene() {
        ...
        this.scene.add(fill);
        this.scene.add(new THREE.GridHelper(20, 20, 0x00ffff, 0x004444));
    }
    ...
    animate() {
        ...
        this.camera.position.x = t.x + Math.sin(this.orbitAngle) * 8;
        this.camera.position.z = t.z + Math.cos(this.orbitAngle) * 8;
        this.camera.position.y = t.y + 3.5;
